...
partial class PurchaseOrderForm {
    ...
    private void InitializeComponent() {
        ...
        this.entrepotComboBox.Location = new Point(0, 509);
        ...
        this.Entrepotlabel.Location = new Point(0, 489);
        ...
        this.StatusComboBox.Location = new Point(0, 461);
        ...
        this.Status.Location = new Point(0, 441);
        ...
        this.QTYnumericUpDown.Location = new Point(0, 414);
        ...
        this.QTYlabel.Location = new Point(0, 394);
        ...
        this.produitListView.Size = new Size(563, 280);
